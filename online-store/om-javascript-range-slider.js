...
function OmRangeSlider(inputElement, inputValueStyle) {
    ...
    function initVisuals() {
        ...
        visualSliderButtonStart.innerHTML = '<div style="position: relative; height: 100%; width: 100%;"><div style="position: absolute; height: 48px; width: 48px; top: 50%; left: 50%; transform: translateY(-50%) translateX(-50%);' + (debug ? ' background: #c2c0c2;' : '') + '"></div></div>';
